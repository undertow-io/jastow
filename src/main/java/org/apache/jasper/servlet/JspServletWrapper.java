        ...
        try {
            ...
            if (options.getDisplaySourceFragment()) {
                    return new JasperException(MESSAGES.jspExceptionWithDetails(detail.getJspFileName(),
                            source.getLineNumber() , source.getLineNumber() + System.lineSeparator() +
                            System.lineSeparator() + detail.getJspExtract() +
                            System.lineSeparator() + System.lineSeparator()), ex);
                    
                }

                return new JasperException(MESSAGES.jspException(detail.getJspFileName(), source.getLineNumber()), ex);
        } catch (Exception je) {
