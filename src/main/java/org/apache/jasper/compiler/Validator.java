        ...
        public void visit(Node.PageDirective n) throws JasperException {
            ...
            for (int i = 0; attrs != null && i < attrs.getLength(); i++) {
                ...
                if ("language".equals(attr)) {
                    ...
                    if (pageEncodingSeen)
                        err.jspError(n, MESSAGES.invalidDuplicatePageDirectiveAttribute(attr));
            ...
            if (pageInfo.getBuffer() == 0 && !pageInfo.isAutoFlush())
                err.jspError(n, MESSAGES.invalidConflictingPageDirectiveAutoFlushBuffer());
        ...
        public void visit(Node.TagDirective n) throws JasperException {
            ...
            for (int i = 0; attrs != null && i < attrs.getLength(); i++) {
                ...
                if ("language".equals(attr)) {
                    ...
                    if (pageEncodingSeen)
                        err.jspError(n, MESSAGES.invalidDuplicateTagDirectiveAttribute(attr));
                    pageEncodingSeen = true;
    ...
    private static class ValidateVisitor extends Node.Visitor {
        ...
        public void visit(Node.TaglibDirective n) throws JasperException {
            ...
            if (uri == null && tagdir == null) {
                err.jspError(n, MESSAGES.invalidTaglibDirectiveMissingLocation());
            }
            if (uri != null && tagdir != null) {
                err.jspError(n, MESSAGES.invalidTaglibDirectiveConflictingLocation());
            }
        }
        ...
        public void visit(Node.SetProperty n) throws JasperException {
            ...
            if ("*".equals(property)) {
                if (param != null || valueSpecified)
                    err.jspError(n, MESSAGES.invalidSetProperty());
            } else if (param != null && valueSpecified) {
                err.jspError(n, MESSAGES.invalidSetPropertyEitherParam());
            }
        ...
        public void visit(Node.UseBean n) throws JasperException {
            ...
            if (className == null && type == null)
                err.jspError(n, MESSAGES.missingUseBeanType());

            if (beanInfo.checkVariable(name))
                err.jspError(n, MESSAGES.duplicateUseBeanName(name));

            if ("session".equals(scope) && !pageInfo.isSession())
                err.jspError(n, MESSAGES.cannotAccessSessionScopeWithUseBean());

            Node.JspAttribute jattr = getJspAttribute(null, "beanName", null,
                    null, n.getAttributeValue("beanName"), n, null, false);
            n.setBeanName(jattr);
            if (className != null && jattr != null)
                err.jspError(n, MESSAGES.cannotUseBothAttributeAndTypeInUseBean());
        ...
        public void visit(Node.ELExpression n) throws JasperException {
            ...
            if (n.getType() == '#') {
                if (!pageInfo.isDeferredSyntaxAllowedAsLiteral()) {
                    err.jspError(n, MESSAGES.invalidDeferredExpressionInTemplateText());
                } else {
                    return;
                }
            }
        ...
        public void visit(Node.UninterpretedTag n) throws JasperException {
            if (n.getNamedAttributeNodes().size() != 0) {
                err.jspError(n, MESSAGES.invalidJspAttribute());
            }
        ...
        public void visit(Node.CustomTag n) throws JasperException {
            ...
            if (tagInfo == null) {
                err.jspError(n, MESSAGES.missingTagInfo(n.getQName()));
            }
            ...
            if (n.implementsSimpleTag()
                ...
                err.jspError(n, MESSAGES.invalidSimpleTagBodyContent(tagInfo
                        .getTagClassName()));
            }
            ...
            if (tagInfo.hasDynamicAttributes()
                ...
                err.jspError(n, MESSAGES.unimplementedDynamicAttributes(n.getQName()));
            }
            ...
            for (int i = 0; i < tldAttrs.length; i++) {
                ...
                if (tldAttrs[i].isRequired() && attr == null && na == null) {
                    err.jspError(n, MESSAGES.missingMandatoryAttribute(n.getLocalName(), tldAttrs[i]
                            .getName()));
                }
                if (attr != null && na != null) {
                    err.jspError(n, MESSAGES.duplicateAttribute(tldAttrs[i].getName()));
                }
            }
            ...
            if (tei != null && tei.getVariableInfo(tagData) != null
                ...
                err.jspError(n, MESSAGES.invalidTeiWithVariableSubelements(n.getQName()));
            }
        ...
        public void visit(Node.JspElement n) throws JasperException {
            ...
            Attributes attrs = n.getAttributes();
            if (attrs == null) {
                err.jspError(n, MESSAGES.missingMandatoryAttributes());
            }
            ...
            if (n.getNameAttribute() == null) {
                err.jspError(n, MESSAGES.missingMandatoryNameAttribute());
            }
        ...
        public void visit(Node.JspOutput n) throws JasperException {
            ...
            if (n.getBody() != null) {
                err.jspError(n, MESSAGES.invalidJspOutputBody());
            }
            ...
            if (omitXmlDecl != null && omitXmlDeclOld != null
                ...
                err.jspError(n, MESSAGES.invalidJspOutputConflict
            ...
            if (doctypeName == null && doctypeSystem != null
                ...
                err.jspError(n, MESSAGES.errorJspOutputDoctype());
            }

            if (doctypePublic != null && doctypeSystem == null) {
                err.jspError(n, MESSAGES.errorJspOutputMissingDoctype());
            }
        ...
        public void visit(Node.InvokeAction n) throws JasperException {
            ...
            if (scope != null && var == null && varReader == null) {
                err.jspError(n, MESSAGES.missingVarAttribute());
            }
            if (var != null && varReader != null) {
                err.jspError(n, MESSAGES.errorBothVarAttributes());
            }
        }
                        ...
                        if (node instanceof ELNode.Root) {
                            if (((ELNode.Root) node).getType() == '$') {
                                if (elExpression && deferred) {
                                    err.jspError(n, MESSAGES.errorUsingBothElTypes());
                                }
                                elExpression = true;
                                ...
                                if (expectedType != null) {
                                    ...
                                    if (String.class.equals(expectedClass) ||
                                        ...
                                        try {
                                            ...
                                            err.jspError
                                                (n, MESSAGES.errorCoercingAttributeValue(
        ...
        private void validateFunctions(ELNode.Nodes el, Node n)
            ...
            class FVVisitor extends ELNode.Visitor {
                ...
                public void visit(ELNode.Function func) throws JasperException {
                    ...
                    if (funcInfo == null) {
                        err.jspError(n, MESSAGES.unknownFunction(function));
                    }
                ...
                public void visit(ELNode.Function n) throws JasperException {
                    ...
                    try {
                        ...
                        err.jspError(MESSAGES.missingFunctionClass
                                (n.getFunctionInfo().getFunctionClass(), n
                                .getPrefix()
                    ...
                    try {
                        ...
                        err.jspError(MESSAGES.missingSignatureClass(paramTypes[i], n.getPrefix() + ':'
                                        + n.getName()), e.getMessage());
